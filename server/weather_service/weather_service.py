...
class WeatherService:
    ...
    def _extract_tonight_data(self, weather_data):
        ...
        tonight_relevant_data = self._extract_basic_tonight_information(weather_data["daily"])
        tonight_relevant_data["hourly"] = self._extract_hourly_tonight_information(weather_data["hourly"], tonight_relevant_data["sunset"], tonight_relevant_data["sunrise"])
    ...
    def _extract_hourly_tonight_information(self, hourly_weather_data, sunset, sunrise):
        ...
        for hour in hourly_weather_data:
            nighttime = self._is_after_sunset(hour["dt"], sunset) and self._is_before_sunrise(hour["dt"], sunrise)
            if nighttime: 
                hour_weather = {}
